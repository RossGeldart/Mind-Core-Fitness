    ...
    <div className="client-dashboard">
      ...
      >
        ...
        <div className="quick-actions" style={{ marginTop: '-8px' }}>
          <button className="forms-btn ripple-btn" onClick={(e) => { createRipple(e); navigate('/client/personal-bests'); }}>
            Personal Bests & Progress
          </button>
          <button className="tools-btn ripple-btn" onClick={(e) => { createRipple(e); navigate('/client/leaderboard'); }}>
            Leaderboard
          </button>
        </div>
      ...
      <div className={`fab-container ${fabOpen ? 'open' : ''}`}>
        ...
        <div className="fab-actions">
          ...
          <button
            className="fab-action ripple-btn"
            onClick={(e) => { createRipple(e); setFabOpen(false); navigate('/client/leaderboard'); }}
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
