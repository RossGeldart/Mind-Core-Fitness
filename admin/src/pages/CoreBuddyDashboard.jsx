    ...
    <div className="cb-dashboard" data-theme={isDark ? 'dark' : 'light'}>
      ...
      <main className="cb-main">
        ...
        <div className="cb-features">
          ...
          {/* 4. Achievements */}
          <button
            className="cb-feature-card cb-card-achievements ripple-btn"
            onClick={(e) => { createRipple(e); navigate('/client/core-buddy/achievements'); }}
          >
            <div className="cb-card-icon cb-icon-achievements">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="cb-card-content">
              <h3>Achievements</h3>
              <p>Badges, PB targets and volume milestones</p>
            </div>
            <svg className="cb-card-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 18l6-6-6-6"/></svg>
          </button>
