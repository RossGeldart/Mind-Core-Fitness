    ...
    <div className="cb-settings">
      ...
      <main className="settings-main">
        ...
        <section className="settings-section">
          ...
          <button type="button" className="settings-link-row" onClick={() => openExternal('https://www.mindcorefitness.com/privacy-policy.html')}>
            <div className="settings-row-text">
          ...
          <button type="button" className="settings-link-row" onClick={() => openExternal('https://www.mindcorefitness.com/terms.html')}>
            <div className="settings-row-text">
