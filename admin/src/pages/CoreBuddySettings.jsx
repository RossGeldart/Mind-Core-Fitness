    ...
    <div className="cb-settings">
      ...
      <main className="settings-main">
        ...
        <section className="settings-section">
          ...
          <a href="https://www.mindcorefitness.com/privacy-policy" target="_blank" rel="noopener noreferrer" className="settings-link-row">
            <div className="settings-row-text">
          ...
          <a href="https://www.mindcorefitness.com/terms" target="_blank" rel="noopener noreferrer" className="settings-link-row">
            <div className="settings-row-text">
