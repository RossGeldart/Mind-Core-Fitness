...
export default function Login() {
  ...
  if (authLoading || (currentUser && !verificationSent)) {
    return (
  ...
  // ── Verification screen (NativeLogin style) ──
  if (verificationSent && showSocial) {
    return (
  ...
  // ── Core Buddy: NativeLogin-style full-screen layout ──
  if (showSocial) {
    return (
      <div className="native-login">
        <ThemeToggle className="login-theme-toggle" />

        <button className="native-login-back" onClick={() => navigate('/')}>
        ...
        {resetSent ? (
          ...
          <div className="native-login-actions">
            ...
            {!showEmail ? (
              ...
              <form onSubmit={handleSubmit} className="native-login-email-form">
                <div className="native-login-field">
